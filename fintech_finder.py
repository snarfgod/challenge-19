...
st.sidebar.write("ETH Balance", get_balance(w3, account.address))
...
for x in candidate_database:
    wage = candidate_database[x][3] * hours
    st.sidebar.write("Total Wage", candidate_database[x][0], wage)
